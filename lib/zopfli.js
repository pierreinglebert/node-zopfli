...
function defaults(source, defaultValues) {
  return Object.keys(defaultValues).reduce(function(options, key) {
    options[key] = (source && source[key] !== undefined) ? opts[key] : defaultValues[key];
    return options;
  }, {});
}
